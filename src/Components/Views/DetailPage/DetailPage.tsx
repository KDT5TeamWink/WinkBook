...
function DetailPage(){
  ...
  return(
    ...
    <div className="DetailContainer">
      ...
      <div className="RightContainer">
        ...
        <div className="RightContainer-Content">
          ...
          <div className="ButtonContainer">
            <button className="CartAdd" onClick={()=> BuyBook(detail)}> 책 구매하기</button>
      ...
      <span className='BookContent-text'>출판사 제공 <br/>책소개</span>
      <div className={`TopBox ${isScrolled ? 'slide-down' : ''}`}>
        {isScrolled ? <TopHeader productName={detail.product_name} productPrice={detail.price}/> : ""}
      </div> 
